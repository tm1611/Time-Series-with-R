...
Some example of time series with various qualities. For example the `AirPassengers` data from Box and Jenkins show seasonality, trend and heteroscedasticity, which distinguishes the data from white noise.
...
## Coefficients:
##          ar1      ar2  intercept
##       1.4293  -0.6988    49.5953
## s.e.  0.0501   0.0505     0.2901
## 
## sigma^2 estimated as 1.223:  log likelihood = -305.22,  aic = 618.45
```
...
## ar1     0.9009 0.0402 22.3982  0.0000
## xmean   0.2508 0.9089  0.2759  0.7832
```
...
```
##       Estimate     SE  t.value p.value
## ar1     0.9006 0.0247  36.4335       0
## ma1    -0.4429 0.0494  -8.9577       0
## xmean  50.4856 0.2384 211.7566       0
```
